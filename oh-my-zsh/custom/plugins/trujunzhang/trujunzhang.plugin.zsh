...
# nvm
alias dnvmreset="cd ~/ && git clone file:///Users/djzhang/Documents/Organizations/IDES/nvm/localNVM .nvm && cd ~/.nvm  && git checkout v0.34.0 && . ~/.nvm/nvm.sh && nvm install 12.12 && nvm use 12.12"