...
-- local active_file = os.getenv("HOME") .. "/.config/neovim-linkarzu/lua/config/active-colorscheme.sh"
local colors = dofile(os.getenv("HOME") .. "/.config/neovim-linkarzu/lua/config/colors.lua")
